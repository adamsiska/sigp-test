  ...
  return (
    <div className="bg-white shadow overflow-hidden sm:rounded-lg lg:m-20 lg:mx-36">
      <div className="px-4 py-5 sm:px-6">
        <h3 className="text-lg leading-6 font-medium text-gray-900">About movie</h3>
        <p className="mt-1 max-w-2xl text-sm text-gray-500">All details witch we have now.</p>
      </div>
